...
const Expense = StyleSheet.create({
  madePaymentForContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  },
  madePaymentForCategoryContainer: {
    flex: 0.4875,
    justifyContent: 'center',
  },
  madePaymentForSubCategoryContainer: {
    flex: 0.4875,
    justifyContent: 'center',
  },
  ...
  expenseDetailAccordionContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  ...
  expenseDetailAccordionLabelContainer: {
    flex: 0.85,
    justifyContent: 'center',
  },
  expenseDetailAccordionImageContainer: {
    flex: 0.15,
    alignItems: 'center',
    justifyContent: 'center',
  },
  expenseDetailAccordionImage: {
    width: 20,
    height: 20,
    tintColor: Colors.primaryText,
  },
  expenseDetailContainer: {flex: 1, marginHorizontal: 20, marginVertical: 16},
  ...
  claimableExpenseGroupModalContainer: {
    borderRadius: 20,
    marginHorizontal: 18,
    shadowColor: Colors.dropShadow,
    shadowOffset: {
