...
import Styles from '../../../styles/appStyles/community/Followings';
          ...
          {Boolean(followings) ? (
            Array.isArray(followings) && followings.length != 0 ? (
              <ScrollView
                ...
                {followings.map((followingData, index) => (
                  <View
                    key={index}
                    ...
                    <UserCard {...props} data={followingData} />
                  </View>
                ))}
              </ScrollView>
            ) : (
